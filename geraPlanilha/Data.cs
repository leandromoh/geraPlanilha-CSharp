...
namespace geraPlanilha
{
    public class Data
    {
        ...
        public static bool consistirData(int t0, int t1, int t2)
        {
        ...
        public static bool mudaFormato(int f)
        {
            switch (f)
            {
                case 0:
                    setFormato(0, 1, 2, '/'); break;
                case 1:
                    setFormato(1, 0, 2, '/'); break;
                case 2:
                    setFormato(0, 1, 2, '-'); break;
                case 3:
                    setFormato(0, 1, 2, '.'); break;
                case 4:
                    setFormato(2, 1, 0, '.'); break;
                default:
                    return false;
            }
        ...
        public bool stringData(String s)
        {
            setDataFromString(s);
        ...
        private void setDataFromString(String s)
        {
            ...
            componentes[termos[0]] = int.Parse(sub1);
            componentes[termos[1]] = int.Parse(sub2);
            componentes[termos[2]] = int.Parse(sub3);
        }
